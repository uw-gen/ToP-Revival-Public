...
{T_B
	...
	if(g_Config.m_bTradeLogIsConfig)
	{
		...
		//	return FALSE;
		//}
		bool r = _connect.connect(g_Config.driverVersion_, g_Config.m_szTradeLogDBIP, g_Config.m_szTradeLogDBName, g_Config.m_szTradeLogDBUsr, (char*)pswd.c_str(), err_info);
		if(!r)
		{
