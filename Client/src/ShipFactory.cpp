...
void xShipFactory::UpdateBoatAttr()
{
	...
	{ /*显示船只原始属性*/
		sprintf(buf, "%d/%d", (int)pkAttr->get(ATTR_BMNATK), (int)pkAttr->get(ATTR_BMXATK));
		sbf.lbl_prop[SBF_TEXT_ATTACK]->SetCaption(buf);
		sprintf(buf, "%d/%d",(int) pkAttr->get(ATTR_HP),(int) pkAttr->get(ATTR_BMXHP));
		sbf.lbl_prop[SBF_TEXT_ENDURE]->SetCaption(buf);
		sprintf(buf, "%d/%d",(int) pkAttr->get(ATTR_SP),(int) pkAttr->get(ATTR_BMXSP));
		sbf.lbl_prop[SBF_TEXT_SUPPLY]->SetCaption(buf);
	...
	{ /*显示船只属性(有人物影响)*/
		sprintf(buf, "%d/%d", (int)pkAttr->get(ATTR_MNATK), (int)pkAttr->get(ATTR_MXATK));
		sbf.lbl_prop[SBF_TEXT_ATTACK]->SetCaption(buf);
		sprintf(buf, "%d/%d", (int)pkAttr->get(ATTR_HP),(int) pkAttr->get(ATTR_MXHP));
		sbf.lbl_prop[SBF_TEXT_ENDURE]->SetCaption(buf);
		sprintf(buf, "%d/%d", (int)pkAttr->get(ATTR_SP), (int)pkAttr->get(ATTR_MXSP));
		sbf.lbl_prop[SBF_TEXT_SUPPLY]->SetCaption(buf);
