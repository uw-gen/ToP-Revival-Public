...
//好友命令定义BEGIN
	...
	#define CMD_CP_FRND_MOVE_GROUP	CMD_CP_BASE	+ 15	//改变好友所属分组
...
// Add by lark.li 20080804 begin
	...
	#define CMD_CP_FRND_CHANGE_GROUP	CMD_CP_BASE	+ 20
// End
...
#define CMD_CP_PING				CMD_CP_BASE	+ 25

// 外挂
//#define CMD_CP_REPORT_WG		CMD_CP_BASE + 21 // 报告发现使用外挂
#define CMD_CP_REPORT_WG		CMD_CP_BASE + 26 // 报告发现使用外挂
// End
...
//好友命令定义BEGIN
	...
	#define	CMD_PC_FRND_MOVE_GROUP	CMD_PC_BASE + 15	//改变好友分组成功
...
// Add by lark.li 20080804 begin
	...
	#define	CMD_PC_FRND_CHANGE_GROUP	CMD_PC_BASE + 20	//改变好友分组成功
// End
...
#define CMD_PC_PING				CMD_PC_BASE	+ 25
// End
